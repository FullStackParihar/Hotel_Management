...
// import { FiBook, FiHome, FiMap, FiTag, FiLogOut, FiMoon, FiSun, FiDollarSign, FiMapPin, FiKey, FiUsers } from 'react-icons/fi';
...
//                     const hotel = room.hotel && typeof room.hotel === 'object' ? room.hotel : null;
//                     const city = hotel && hotel.city && typeof hotel.city === 'object' ? hotel.city : null;
//                     const state = city && city.state && typeof city.state === 'object' ? city.state : null;

//                     const stateName = state && state.name ? state.name : 'Unknown';
//                     const cityName = city && city.name ? city.name : 'Unknown';
//                     const hotelName = hotel && hotel.name ? hotel.name : 'Unknown';

//                     if (byStateMap[stateName]) {
//                         byStateMap[stateName] += revenue;
//                     } else {
//                         byStateMap[stateName] = revenue;
//                     }

//                     if (byCityMap[cityName]) {
//                         byCityMap[cityName] += revenue;
//                     } else {
//                         byCityMap[cityName] = revenue;
//                     }

//                     if (byHotelMap[hotelName]) {
//                         byHotelMap[hotelName] += revenue;
//                     } else {
//                         byHotelMap[hotelName] = revenue;
//                     }
//                 }
