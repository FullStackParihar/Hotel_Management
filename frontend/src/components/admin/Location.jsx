...
//             {/* --------------------------------Sidebar -----------------------------*/}
//             <div className="w-80 bg-gray-800 p-2 flex-shrink-0">
...
//                         {/* Hotel Browser */}
//                         <div className="text-4xl font-bold text-purple-400">View</div>
//                         <UserPanel />
//                     </div>
//                 </div>
//             </div>
...
// import axios from "axios";
// import { Navigate, useNavigate } from "react-router-dom";
// import { FaMapMarkerAlt, FaCity, FaHotel, FaSignOutAlt, FaSearch, FaSort, FaUserAltSlash, FaUserAlt, FaBed, FaCalendarCheck, FaUsers, FaCalendarAlt, FaCheckCircle, FaTimesCircle, FaUser, FaPhone, FaChild } from "react-icons/fa";
// import UserPanel from "../User/UserPanel";
...
//                         <FaUserAlt className="text-indigo-400" /> Admin Panel
//                     </h1>
//                 </div>
...
//                                     sidebarTab === "states" ? "bg-indigo-600 text-white" : "text-gray-300 hover:bg-gray-800"
//                                 }`}
//                             >
...
//                                 onClick={() => setSidebarTab("cities")}
//                                 className={`w-full flex items-center gap-3 p-3 rounded-lg transition-all duration-200 ${
//                                     sidebarTab === "cities" ? "bg-indigo-600 text-white" : "text-gray-300 hover:bg-gray-800"
//                                 }`}
//                             >
//                                 <FaCity /> Cities
//                             </button>
...
//                                 onClick={() => setSidebarTab("hotels")}
//                                 className={`w-full flex items-center gap-3 p-3 rounded-lg transition-all duration-200 ${
//                                     sidebarTab === "hotels" ? "bg-indigo-600 text-white" : "text-gray-300 hover:bg-gray-800"
//                                 }`}
//                             >
//                                 <FaHotel /> Hotels
//                             </button>
...
//                                 onClick={() => setSidebarTab("rooms")}
//                                 className={`w-full flex items-center gap-3 p-3 rounded-lg transition-all duration-200 ${
//                                     sidebarTab === "rooms" ? "bg-indigo-600 text-white" : "text-gray-300 hover:bg-gray-800"
//                                 }`}
//                             >
//                                 <FaBed /> Rooms
//                             </button>
...
//                                 className={`w-full flex items-center gap-3 p-3 rounded-lg transition-all duration-200 ${
//                                     sidebarTab === "bookings" ? "bg-indigo-600 text-white" : "text-gray-300 hover:bg-gray-800"
//                                 }`}
//                             >
...
//                 {/* Management Section */}
//                 <div className="w-1/3 bg-gradient-to-br from-slate-900 to-blue-900 p-6 shadow-md border-r border-gray-200 overflow-y-auto">
//                     {error && (
...
//                     {sidebarTab === "states" && (
//                         <div>
//                             <h2 className="text-xl font-semibold mb-4">Manage States</h2>
//                             <form onSubmit={handleStateSubmit} className="space-y-4 mb-6">
//                                 <div>
//                                     <label htmlFor="state-name" className="block text-sm font-medium text-white">
//                                         State Name
//                                     </label>
//                                     <input
//                                         id="state-name"
...
//                                 </div>
//                                 <div>
//                                     <label htmlFor="state-code" className="block text-sm font-medium text-white">
//                                         State Code
//                                     </label>
//                                     <input
//                                         id="state-code"
...
//                                         stateTab === "active" ? "bg-indigo-600 text-white" : "bg-gray-200 text-white"
//                                     }`}
//                                 >
//                                     Active
//                                 </button>
...
//                                     onClick={() => setStateTab("inactive")}
//                                     className={`flex-1 py-2 rounded-md ${
//                                         stateTab === "inactive" ? "bg-red-600 text-white" : "bg-gray-200 text-white"
//                                     }`}
//                                 >
//                                     Inactive
//                                 </button>
...
//                                 ))}
//                                 {(stateTab === "active" ? states : inactiveStates).length === 0 && (
//                                     <li className="text-center text-gray-500 py-4">No {stateTab} states found.</li>
//                                 )}
//                             </ul>
//                         </div>
//                     )}
...
//                     {sidebarTab === "cities" && (
//                         <div>
//                             <h2 className="text-xl font-semibold mb-4">Manage Cities</h2>
//                             <form onSubmit={handleCitySubmit} className="space-y-4 mb-6">
//                                 <div>
//                                     <label htmlFor="city-name" className="block text-sm font-medium text-white">
//                                         City Name
//                                     </label>
//                                     <input
//                                         id="city-name"
...
//                                 </div>
//                                 <div>
//                                     <label htmlFor="city-state" className="block text-sm font-medium text-white">
//                                         State
//                                     </label>
//                                     <select
//                                         id="city-state"
...
//                                     onClick={() => setCityTab("active")}
//                                     className={`flex-1 py-2 rounded-md ${
//                                         cityTab === "active" ? "bg-indigo-600 text-white" : "bg-gray-200 text-white"
//                                     }`}
//                                 >
//                                     Active
//                                 </button>
...
//                                     onClick={() => setCityTab("inactive")}
//                                     className={`flex-1 py-2 rounded-md ${
//                                         cityTab === "inactive" ? "bg-red-600 text-white" : "bg-gray-200 text-white"
//                                     }`}
//                                 >
//                                     Inactive
//                                 </button>
...
//                                 ))}
//                                 {(cityTab === "active" ? cities : inactiveCities).length === 0 && (
//                                     <li className="text-center text-gray-500 py-4">No {cityTab} cities found.</li>
//                                 )}
//                             </ul>
//                         </div>
//                     )}
...
//                                 <div>
//                                     <label htmlFor="hotel-state" className="block text-sm font-medium text-white">
//                                         State
//                                     </label>
//                                     <select
//                                         id="hotel-state"
...
//                                 </div>
//                                 <div>
//                                     <label htmlFor="hotel-city" className="block text-sm font-medium text-white">
//                                         City
//                                     </label>
//                                     <select
//                                         id="hotel-city"
...
//                                 </div>
//                                 <div>
//                                     <label htmlFor="hotel-name" className="block text-sm font-medium text-white">
//                                         Hotel Name
//                                     </label>
//                                     <input
//                                         id="hotel-name"
...
//                                 </div>
//                                 <div>
//                                     <label htmlFor="hotel-address" className="block text-sm font-medium text-white">
//                                         Address
//                                     </label>
//                                     <input
//                                         id="hotel-address"
...
//                                 </div>
//                                 <div>
//                                     <label htmlFor="hotel-rating" className="block text-sm font-medium text-white">
//                                         Rating (1-5)
//                                     </label>
//                                     <input
//                                         id="hotel-rating"
...
//                                 </div>
//                                 <div>
//                                     <label htmlFor="hotel-amenities" className="block text-sm font-medium text-white">
//                                         Amenities (comma-separated)
//                                     </label>
//                                     <input
//                                         id="hotel-amenities"
...
//                                 <div className="flex gap-4">
//                                     <div className="flex-1">
//                                         <label htmlFor="hotel-price-min" className="block text-sm font-medium text-white">
//                                             Price Min
//                                         </label>
//                                         <input
//                                             id="hotel-price-min"
...
//                                     </div>
//                                     <div className="flex-1">
//                                         <label htmlFor="hotel-price-max" className="block text-sm font-medium text-white">
//                                             Price Max
//                                         </label>
//                                         <input
//                                             id="hotel-price-max"
...
//                                 </div>
//                                 <div>
//                                     <label htmlFor="hotel-contact-phone" className="block text-sm font-medium text-white">
//                                         Contact Phone
//                                     </label>
//                                     <input
//                                         id="hotel-contact-phone"
...
//                                 </div>
//                                 <div>
//                                     <label htmlFor="hotel-contact-email" className="block text-sm font-medium text-white">
//                                         Contact Email
//                                     </label>
//                                     <input
//                                         id="hotel-contact-email"
...
//                                 </div>
//                                 <div>
//                                     <label htmlFor="hotel-total-rooms" className="block text-sm font-medium text-white">
//                                         Total Rooms
//                                     </label>
//                                     <input
//                                         id="hotel-total-rooms"
...
//                                     onClick={() => setHotelTab("active")}
//                                     className={`flex-1 py-2 rounded-md ${
//                                         hotelTab === "active" ? "bg-indigo-600 text-white" : "bg-gray-200 text-white"
//                                     }`}
//                                 >
//                                     Active
//                                 </button>
...
//                                     onClick={() => setHotelTab("inactive")}
//                                     className={`flex-1 py-2 rounded-md ${
//                                         hotelTab === "inactive" ? "bg-red-600 text-white" : "bg-gray-200 text-white"
//                                     }`}
//                                 >
//                                     Inactive
//                                 </button>
...
//                                 ))}
//                                 {(hotelTab === "active" ? hotels : inactiveHotels).length === 0 && (
//                                     <li className="text-center text-gray-500 py-4">No {hotelTab} hotels found.</li>
//                                 )}
//                             </ul>
//                         </div>
//                     )}
...
//                                 <div>
//                                     <label htmlFor="room-state" className="block text-sm font-medium text-white">
//                                         State
//                                     </label>
//                                     <select
//                                         id="room-state"
...
//                                 </div>
//                                 <div>
//                                     <label htmlFor="room-city" className="block text-sm font-medium text-white">
//                                         City
//                                     </label>
//                                     <select
//                                         id="room-city"
...
//                                 </div>
//                                 <div>
//                                     <label htmlFor="room-hotel" className="block text-sm font-medium text-white">
//                                         Hotel
//                                     </label>
//                                     <select
//                                         id="room-hotel"
...
//                                 </div>
//                                 <div>
//                                     <label htmlFor="room-number" className="block text-sm font-medium text-white">
//                                         Room Number
//                                     </label>
//                                     <input
//                                         id="room-number"
...
//                                 </div>
//                                 <div>
//                                     <label htmlFor="room-type" className="block text-sm font-medium text-white">
//                                         Room Type
//                                     </label>
//                                     <input
//                                         id="room-type"
...
//                                 </div>
//                                 <div>
//                                     <label htmlFor="room-price" className="block text-sm font-medium text-white">
//                                         Price
//                                     </label>
//                                     <input
//                                         id="room-price"
...
//                                 </div>
//                                 <div>
//                                     <label htmlFor="room-capacity" className="block text-sm font-medium text-white">
//                                         Capacity (Guests)
//                                     </label>
//                                     <input
//                                         id="room-capacity"
...
//                                 </div>
//                                 <div>
//                                     <label className="block text-sm font-medium text-white">Amenities</label>
//                                     <div className="mt-2 space-y-2">
//                                         {["WiFi", "TV", "Air Conditioning", "Mini Bar", "Room Service", "Balcony"].map((amenity) => (
//                                             <div key={amenity} className="flex items-center">
//                                                 <input
...
//                                                 />
//                                                 <label htmlFor={`room-amenity-${amenity}`} className="ml-2 text-sm text-white">
//                                                     {amenity}
//                                                 </label>
//                                             </div>
//                                         ))}
...
//                                 </div>
//                                 <div>
//                                     <label htmlFor="room-description" className="block text-sm font-medium text-white">
//                                         Description
//                                     </label>
//                                     <textarea
//                                         id="room-description"
...
//                                 </div>
//                                 <div>
//                                     <label htmlFor="room-images" className="block text-sm font-medium text-white">
//                                         Room Images
//                                     </label>
//                                     <input
//                                         id="room-images"
...
//                                         accept="image/jpeg,image/png,image/jpg"
//                                         onChange={handleImageUpload}
//                                         className="w-full border border-gray-300 rounded-md px-3 py-2 text-white file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-indigo-600 file:text-white hover:file:bg-indigo-700"
//                                     />
//                                     {roomForm.images.length > 0 && (
//                                         <div className="mt-4 grid grid-cols-3 gap-4">
//                                             {roomForm.images.map((url, index) => (
...
//                                             className="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500"
//                                         />
//                                         <span className="ml-2 text-sm font-medium text-white">Available</span>
//                                     </label>
//                                 </div>
//                                 <button
//                                     type="submit"
...
//                                     onClick={() => setRoomTab("active")}
//                                     className={`flex-1 py-2 rounded-md ${
//                                         roomTab === "active" ? "bg-indigo-600 text-white" : "bg-gray-200 text-white"
//                                     }`}
//                                 >
//                                     Active
//                                 </button>
...
//                                     onClick={() => setRoomTab("inactive")}
//                                     className={`flex-1 py-2 rounded-md ${
//                                         roomTab === "inactive" ? "bg-red-600 text-white" : "bg-gray-200 text-white"
//                                     }`}
//                                 >
//                                     Inactive
//                                 </button>
...
//                                 ))}
//                                 {(roomTab === "active" ? rooms : inactiveRooms).length === 0 && (
//                                     <li className="text-center text-gray-500 py-4">No {roomTab} rooms found.</li>
//                                 )}
//                             </ul>
//                         </div>
//                     )}
...
//                 {/* View Section */}
//                 <div className="flex-1 p-6 overflow-y-auto bg-gradient-to-br from-slate-900 to-blue-900">
//                     <div className="bg-gradient-to-r from-slate-800/90 to-blue-900/90 rounded-2xl shadow-xl p-6">
