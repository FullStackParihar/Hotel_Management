...
//   FaSortAmountUp, FaSortAmountDown, FaCalendarAlt
// } from "react-icons/fa";
...
//   // Filter hotels by rating and search term
...
//             <>
//               {/* Default View (when no state or city is selected) */}
...
//                       >
//                         {/* Use a room image if available, otherwise a fallback image */}
...
//                 </div>
//               ) : (
//                 /* Filtered View (when state or city is selected) */
          ...
          <div className="bg-slate-800 rounded-xl shadow-2xl w-11/12 max-w-4xl flex overflow-hidden">
            ...
            <div className="w-7/12 p-6 bg-gradient-to-br from-slate-900 to-blue-900">
              <h3 className="text-2xl font-semibold text-blue-300 mb-4">
                Room {selectedRoom.roomNumber} ({selectedRoom.type || "Standard"})
              </h3>
