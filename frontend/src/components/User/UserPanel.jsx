...
//   FaUsers, FaPhone, FaChild, FaListAlt
// } from "react-icons/fa";
...
//   const [showBookingsModal, setShowBookingsModal] = useState(false); // New state for bookings modal
...
//       console.log("fetchAllHotels - Response:", response.data);
//       const activeHotels = response.data.filter((h) => h.isActive);
//       console.log("fetchAllHotels - Active Hotels:", activeHotels);
//       setHotels(activeHotels);
//       setExpandedHotels({});
//     } catch (err) {
...
import {
  ...
  FaRegStar, FaCoffee, FaSwimmingPool, FaParking, FaArrowDown,
  FaSortAmountUp, FaSortAmountDown, FaCalendarAlt, FaTimes,
  FaUsers, FaPhone, FaChild, FaListAlt, FaCheck
} from "react-icons/fa";
import { useNavigate } from "react-router-dom";
import { jwtDecode } from "jwt-decode";
