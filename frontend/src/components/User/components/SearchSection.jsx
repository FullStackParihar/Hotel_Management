...
import { FaSearch, FaMapMarkerAlt, FaStar, FaRegStar, FaSortAmountUp, FaSortAmountDown, FaArrowDown } from "react-icons/fa";
      ...
      <div className="mt-6">
        ...
        {showFilters && (
          <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4 border-t border-slate-600/50">
            <div>
              <label className="block text-sm font-semibold text-gray-200 mb-2">Minimum Rating</label>
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-200 mb-2">Sort by Rating</label>
              <div className="flex items-center space-x-3">
                <button
                  onClick={() => onSortOrderChange(sortOrder === "asc" ? "" : "asc")}
                  className={`flex items-center px-4 py-2 rounded-lg transition-all duration-200 ${
                    sortOrder === "asc" ? "bg-blue-600 text-white" : "bg-slate-700/80 text-gray-300 hover:bg-slate-600"
                  }`}
                ...
                <button
                  onClick={() => onSortOrderChange(sortOrder === "desc" ? "" : "desc")}
                  className={`flex items-center px-4 py-2 rounded-lg transition-all duration-200 ${
                    sortOrder === "desc" ? "bg-blue-600 text-white" : "bg-slate-700/80 text-gray-300 hover:bg-slate-600"
                  }`}
