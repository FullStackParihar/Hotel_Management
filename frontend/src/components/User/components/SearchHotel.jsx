...
//   const [isDarkMode] = useDarkMode(); // Using useDarkMode hook

//   return (
//     <section className={`${isDarkMode ? 'bg-gradient-to-r from-gray-800/90 to-blue-900/90' : 'bg-gradient-to-r from-gray-200/90 to-blue-200/90'} rounded-2xl p-8 shadow-xl mb-10 backdrop-blur-md transform -mt-24 mx-4 lg:mx-auto`}>
//       <h2 className={`text-2xl font-semibold ${isDarkMode ? 'text-blue-300' : 'text-blue-600'} mb-6 flex items-center`}>
//         <FaSearch className="mr-2" /> Search Hotels
//       </h2>
//       <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
//         <div>
//           <label htmlFor="state-select" className={`block text-sm font-semibold ${isDarkMode ? 'text-gray-200' : 'text-gray-700'} mb-2`}>
//             Select State
//           </label>
...
//               className={`${isDarkMode ? 'bg-gray-700/80 border-gray-600 text-gray-100 focus:ring-blue-400 focus:border-blue-400' : 'bg-gray-200/80 border-gray-300 text-gray-800 focus:ring-blue-500 focus:border-blue-500'} w-full border rounded-lg px-4 py-3 focus:outline-none focus:ring-2 transition-all duration-200 appearance-none`}
...
//         </div>
//         <div>
//           <label htmlFor="city-select" className={`block text-sm font-semibold ${isDarkMode ? 'text-gray-200' : 'text-gray-700'} mb-2`}>
//             Select City
//           </label>
//           <div className="relative">
//             <select
...
//               className={`${isDarkMode ? 'bg-gray-700/80 border-gray-600 text-gray-100 focus:ring-blue-400 focus:border-blue-400 disabled:bg-gray-600/50 disabled:text-gray-400' : 'bg-gray-200/80 border-gray-300 text-gray-800 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-300/50 disabled:text-gray-600'} w-full border rounded-lg px-4 py-3 focus:outline-none focus:ring-2 disabled:cursor-not-allowed transition-all duration-200 appearance-none`}
...
//         </div>
//         <div>
//           <label htmlFor="search-hotel" className={`block text-sm font-semibold ${isDarkMode ? 'text-gray-200' : 'text-gray-700'} mb-2`}>
//             Search Hotel
//           </label>
//           <div className="relative">
//             <input
...
//               className={`${isDarkMode ? 'bg-gray-700/80 border-gray-600 text-gray-100 focus:ring-blue-400 focus:border-blue-400' : 'bg-gray-200/80 border-gray-300 text-gray-800 focus:ring-blue-500 focus:border-blue-500'} w-full border rounded-lg px-4 py-3 focus:outline-none focus:ring-2 transition-all duration-200`}
...
//           className={`flex items-center ${isDarkMode ? 'text-blue-300 hover:text-blue-200' : 'text-blue-500 hover:text-blue-600'} font-medium transition-colors duration-200`}
...
//         </button>
//         {showFilters && (
//           <div className={`mt-4 grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4 border-t ${isDarkMode ? 'border-gray-600/50' : 'border-gray-300/50'}`}>
//             <div>
...
//                         : isDarkMode ? 'text-gray-400 hover:text-yellow-300' : 'text-gray-500 hover:text-yellow-400'
//                     }`}
...
//                   className={`ml-2 text-xs ${isDarkMode ? 'text-gray-300 hover:text-white' : 'text-gray-600 hover:text-gray-800'} px-3 py-1 rounded-full ${isDarkMode ? 'bg-gray-700/80 hover:bg-gray-600' : 'bg-gray-200/80 hover:bg-gray-300'} transition-all duration-200`}
...
const SearchHotels = ({
  ...
  return (
    <section
      className={`${
        isDarkMode ? "bg-gradient-to-r from-gray-800/90 to-blue-900/90" : "bg-gradient-to-r from-gray-200/90 to-blue-200/90"
