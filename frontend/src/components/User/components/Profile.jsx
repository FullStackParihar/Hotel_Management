...
//       <div className="bg-slate-800/90 backdrop-blur-md rounded-2xl shadow-xl p-8 w-full max-w-lg relative">
...
//           <button
//             onClick={() => navigate(-1)}
//             className="p-2 bg-slate-700 hover:bg-slate-600 text-gray-100 rounded-full transition-all duration-200"
//             aria-label="Go back"
//           >
//             <FaTimes size={20} />
//           </button>
...
// import axios from 'axios';
// import { useNavigate } from 'react-router-dom';
// import { FaUser, FaEnvelope, FaPhone, FaVenusMars, FaCalendarAlt, FaLock, FaSignOutAlt, FaEdit, FaSave, FaTimes, FaCamera } from 'react-icons/fa';
...
//         setImagePreview(`${baseURL}${userData.profileImage}`);
//       }
//     } catch (err) {
//       console.error('fetchUser - Error:', err);
//       setError(err.response?.data?.message || 'Failed to fetch user details.');
...
//                   <img
//                     src={imagePreview || `${baseURL}${user.profileImage}`}
//                     alt="Profile"
//                     className="w-32 h-32 rounded-full object-cover border-4 border-blue-500 shadow-lg"
//                   />
//                 ) : (
//                   <div className="w-32 h-32 rounded-full bg-slate-700 flex items-center justify-center text-gray-400 border-4 border-blue-500 shadow-lg">
//                     <FaUser size={40} />
//                   </div>
//                 )}
//                 {isEditing && (
...
//                       setIsEditing(false);
//                       setImageFile(null);
//                       setImagePreview(user.profileImage ? `${baseURL}${user.profileImage}` : null);
//                     }}
//                     className="flex items-center bg-gray-600 hover:bg-gray-500 text-white px-4 py-2 rounded-lg transition-all duration-200 shadow-md"
//                   >
//                     <FaTimes className="mr-2" /> Cancel
          ...
          <div className="space-y-6">
            ...
            <div className="flex justify-center mb-6">
              <div className="relative">
                {imagePreview || user.profileImage ? (
                  <img
                    src={imagePreview || user.profileImage} // Use the URL directly
                    alt="Profile"
                    className="w-32 h-32 rounded-full object-cover border-4 border-blue-500 shadow-lg"
                    onError={(e) => console.error("Image load error:", e)} // Log errors if the image fails to load
                  />
                ) : (
                  <div className="w-32 h-32 rounded-full bg-slate-700 flex items-center justify-center text-gray-400 border-4 border-blue-500 shadow-lg">
                    <FaUser size={40} />
                ...
                <div className="flex space-x-4">
                  ...
                  <button
                    ...
                    onClick={() => {
                      setIsEditing(false);
                      setImageFile(null);
                      setImagePreview(user.profileImage || null); // Use the Cloudinary URL directly
                    }}
                    className="flex items-center bg-gray-600 hover:bg-gray-500 text-white px-4 py-2 rounded-lg transition-all duration-200 shadow-md"
                  >
                    <FaTimes className="mr-2" /> Cancel
