...
//   return (
//     <div className={`min-h-screen ${isDarkMode ? 'bg-gradient-to-br from-slate-900 to-blue-900 text-gray-100' : 'bg-gradient-to-br from-gray-100 to-blue-100 text-gray-900'} font-sans flex items-center justify-center py-12`}>
...
//                   <FaUser className={`${isDarkMode ? 'text-blue-400' : 'text-blue-500'} mr-3`} />
//                   <p>
//                     <strong className={`${isDarkMode ? 'text-blue-200' : 'text-blue-600'}`}>Role:</strong> {user.role}
//                   </p>
//                 </div>
...
//     "https://images.unsplash.com/photo-1507521628349-0b525e465e5b?w=1920",
//     "https://images.unsplash.com/photo-1449824913935-59a10b8d2000?w=1920",
//     "https://images.unsplash.com/photo-1472214103451-9374a3b28c9a?w=1920",
//   ];
...
//                       selectedBackgroundImage === image ? 'border-blue-500' : 'border-transparent'
//                     }`}
...
const Profile = () => {
  ...
  const backgroundImages = [
    ...
    "https://images.unsplash.com/photo-1727422969654-050f3a877c4f?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxleHBsb3JlLWZlZWR8MXx8fGVufDB8fHx8fA%3D%3D",
  ];
