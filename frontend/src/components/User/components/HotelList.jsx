...
// import { FaHotel, FaMapMarkerAlt, FaBed, FaSwimmingPool, FaParking, FaCoffee, FaStar, FaRegStar } from "react-icons/fa";
...
const HotelList = ({
  ...
  // Ensure hotels is an array; default to [] if undefined or not an array
  const safeHotels = Array.isArray(hotels) ? hotels : [];
  console.log("HotelList - hotels prop:", hotels, "safeHotels:", safeHotels); // Debug log

  const filteredHotels = safeHotels
    .filter((hotel) => {
      try {
        const hotelRating = hotel.rating ?? 0;
        const meetsRatingFilter = filterRating === 0 || hotelRating >= filterRating;
